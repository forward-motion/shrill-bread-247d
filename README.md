...
```
npm create cloudflare@latest -- --template=cloudflare/templates/shrill-bread-247d
```

## Preview Deployment

A live public deployment of this template is available at [https://shrill-bread-247d.templates.workers.dev](https://shrill-bread-247d.templates.workers.dev)
